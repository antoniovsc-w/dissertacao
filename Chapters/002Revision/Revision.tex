...
%---------------------- ESTOU AQUI ---------------------------------------------
O artigo \cite{Thakur2020SGMD} utiliza um módulo plano de SGMD com membrana de PTFE e PVDF, com diâmetros de poro entre 0,1 e 0,45~$\mu m$, com temperatura de alimentação entre 40 e 80~$^\circ$C com vazão entre 15 e 75 L/h. O gás de varredura utilizado foi o ar, com vazão entre 50 e 300 L/h. A água de produção utilizada foi obtida da bacia permiana no Texas. Foram realizados testes de 24 horas e 125 horas.
