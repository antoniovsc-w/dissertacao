...
Em relação ao LEP, as membranas M4 e M6 apresentam maior probabilidade de molhamento, associado aos elevados diâmetros de poro observados. Além disso, verificou-se que as distribuições de poro das membranas diferem de uma distribuição normal. Dessa forma, será realizada uma análise estatística mais aprofundada, para determinar as incertezas associadas.
