...
As membranas avaliadas foram adquiridas do fabricante Tish Scientific~\cite{TischScientific} e são produzidas com diferentes materiais e suportes, conforme descrito na tabela \ref{tab:membranas}.
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth, height=11cm, keepaspectratio]{Porolux.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, height=7cm, keepaspectratio]{exemplocurvasporometer.png}
